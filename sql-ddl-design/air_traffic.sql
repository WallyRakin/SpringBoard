...
CREATE INDEX idx_tickets_airline ON tickets(airline);
CREATE INDEX idx_tickets_from_city ON tickets(from_city);
CREATE INDEX idx_tickets_to_city ON tickets(to_city);
